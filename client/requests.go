...
func FromRequest(r *http.Request) (*Request, error) {
	...
	if r.Body != nil {
		...
		req.ContentLength, err = getLength(r.Body)
		if err != nil {
			return nil, err
		}
	}
...
func NewRequestFromURL(url, method string, body interface{}) (*Request, error) {
	return NewRequestFromURLWithContext(context.Background(), url, method, body)
}
...
func NewRequest(method, url string, body interface{}) (*Request, error) {
	return NewRequestFromURL(url, method, body)
}
...
func NewRequestWithContext(ctx context.Context, method, url string, body interface{}) (*Request, error) {
	return NewRequestFromURLWithContext(ctx, url, method, body)
}
